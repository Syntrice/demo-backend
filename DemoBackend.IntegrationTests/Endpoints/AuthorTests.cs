    ...
    : IClassFixture<IntegrationTestFixture>
{
    ...
    {
        var response = await fixture.Client.GetAsync("/api/author");
    ...
    public async Task GetAuthorById_ReturnsAuthor()
    {
        ...
        var response = await fixture.Client.GetAsync($"/api/author/{id}");
        response.StatusCode.ShouldBe(HttpStatusCode.OK);
    ...
    public async Task UpdateAuthor_ReturnsNoContent()
    {
        ...
        var response = await fixture.Client.PutAsJsonAsync($"/api/author/{id}", update);
    ...
    {
        var id = await CreateAuthorAsync();
        var response = await fixture.Client.DeleteAsync($"/api/author/{id}");
        response.StatusCode.ShouldBe(HttpStatusCode.NoContent);
    }
